...
//                bulletY = shipY - 30;
//                lastBulletY = bulletY;
//                bullets.push([bulletX, bulletY, lastBulletY]);
//                ctx.drawImage(imgBullet, bullet[0], bullet[1]);
//            } else {
//                ctx.drawImage(imgBullet, bullet[0], bullet[1] - (20 * i));
//                lastBulletY = bullet[1] - (20 * i);
//                if (lastBulletY <= 10) {
//                    bullets = [];
//                    lastBulletY = 405;
//                    bullets.push([bulletX, bulletY, lastBulletY]);
...
//        var pos = 0;
//        for (var j = 0; j < noOfAliens; j++) {
//            if (bullets[bullets.length - 1][0] <= (fallingAliens[j].x + 35) &&
//                    (fallingAliens[j].x - 10) <= (bullets[bullets.length - 1][0]) &&
//                    bullets[bullets.length - 1][2] <= (fallingAliens[j].y + 35) &&
//                    (fallingAliens[j].y - 400) <= (bullets[bullets.length - 1][2])) {
//                pos = $.inArray(fallingAliens[j].id, killedAliens);
//                if (pos === -1) {
//                    
//                    killedAliens.push(fallingAliens[j].id);
    ...
    function drawAliens() {
        ...
        for (var i = 0; i < noOfAliens; i++) {
            ...
            if ((fallingAliens[i].x <= (shipX + 100) && fallingAliens[i].x >= (shipX - 27)) && (fallingAliens[i].y <= (shipY + 120) && fallingAliens[i].y >= (shipY - 10))) {
                //should limit to only one reduction for a collission
